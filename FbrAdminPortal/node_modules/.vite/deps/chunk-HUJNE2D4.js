...
// node_modules/ra-i18n-polyglot/dist/index.js
var import_node_polyglot = __toESM(require_node_polyglot());
var dist_default = (getMessages, initialLocale = "en", availableLocales = [{ locale: "en", name: "English" }], polyglotOptions = {}) => {
  ...
  const polyglot = new import_node_polyglot.default({
    locale,
    phrases: { "": "", ...messages },
  ...
  return {
    ...
    changeLocale: (newLocale) => (
      ...
      Promise.resolve(getMessages(newLocale)).then((messages2) => {
        locale = newLocale;
        const newPolyglot = new import_node_polyglot.default({
          locale: newLocale,
          phrases: { "": "", ...messages2 },
          ...polyglotOptions
        });
...
//# sourceMappingURL=chunk-HUJNE2D4.js.map
