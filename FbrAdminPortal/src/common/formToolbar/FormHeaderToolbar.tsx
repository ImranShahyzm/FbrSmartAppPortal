...
export function FormHeaderToolbar({
    ...
    return (
        <TopToolbar>
            {showSave ? (
                <Tooltip title={disableSave ? 'Read only' : 'Save'}>
                    <span>
                        <IconButton
                            size="small"
                            onClick={fireSave}
            ...
            {showDelete ? (
                <Tooltip title={disableDelete ? 'Cannot delete' : 'Delete'}>
                    <span>
                        <IconButton
                            size="small"
                            onClick={onDelete}
            ...
            <Tooltip title="Close">
                <IconButton size="small" onClick={() => navigate(listPath)} sx={{ color: 'text.primary' }}>
