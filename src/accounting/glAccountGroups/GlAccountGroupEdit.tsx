...
const GL_ACCOUNT_GROUPS_THREAD_KEY = 'glAccountGroups';

export default function GlAccountGroupEdit() {
    ...
    return (
        ...
        >
            <SimpleForm sx={{ maxWidth: 'none', width: '100%' }} toolbar={false}>
                <SplitFormLayout sidebar={<RecordThreadPanel resourceKey={GL_ACCOUNT_GROUPS_THREAD_KEY} />}>
                    <GlAccountGroupFormInner variant="edit" />
                </SplitFormLayout>
            </SimpleForm>
        </Edit>
    );
