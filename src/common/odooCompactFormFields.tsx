...
/** Odoo-style bold compact labels (shared: product profile, customer, company). */
...
/** Bottom border only — `variant="standard"` compact inputs */
...
export const CompactDateInput = (props: React.ComponentProps<typeof DateInput>) => (
    <DateInput
        {...props}
        variant="standard"
        margin="none"
...
export const UNDERLINE_FIELD_WITH_HELPER_SX = {
    mb: 0,
    '& .MuiInputBase-root': { fontSize: '0.8rem', minHeight: 30 },
    '& .MuiInputBase-input': { py: '5px' },
    '& .MuiInputLabel-root': { display: 'none' },
